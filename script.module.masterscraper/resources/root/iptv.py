...
def iptv4sat():
	...
	udata= xbmc.translatePath('special://home/userdata/addon_data/script.module.masterscraper/downloads/')
	dest = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.module.masterscraper/downloads/', 'iptv4sat.zip'))
	...
	for a in dir:
		if a.endswith('.m3u'):
			...
			os.remove(xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.module.masterscraper/downloads/',a)))
...
logfile    = xbmc.translatePath(os.path.join('special://home/addons/script.module.masterscraper', 'log.txt'))
