...
ORDER          = ['elysium', 'exodus', 'metalliq', 'masterreborn', 'salts', 'saltsrd', 'streamhub', 'covenant', 'rebirth', 'genesisreborn', 'trakt']
...
TRAKTID = { 
	...
	'metalliq': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'rebirthlliq_trakt'),
	...
	'masterreborn': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'masterreborn_trakt'),
		'settings' : os.path.join(ADDOND, 'plugin.video.master.reborn', 'settings.xml'),
		'default'  : 'trakt.user',
		'data'     : ['trakt.user', 'trakt.refresh', 'trakt.token'],
		'activate' : 'RunPlugin(plugin://plugin.video.master.reborn/?action=authTrakt)'},
	'salts': {
	...
	'streamhub': {
		...
		'activate' : 'RunPlugin(plugin://plugin.video.streamhub/?mode=auth_trakt)'},
	'covenant': {
		'name'     : 'Covenant',
