...
#import common
addon_id='plugin.program.sgs.notifications' ##Change this to the same as the addon.xml
...
DefaultSplitter="|||"; 
DefaultUrl="http://tardisbuilds.com/Builds/sgsnotifications.txt"; ##change to where your .txt file is on your host
