...
class indexer:
    def __init__(self):
        ...
        self.cartoons_image = 'http://163.172.46.122/files/master/art/cartoons/art%s.png'
        self.cartoons_fanart = 'http://163.172.46.122/files/master/art/cartoons/fanart.jpg'
        ...
        self.anime_image = 'http://163.172.46.122/files/master/art/anime/art%s.png'
        self.anime_fanart = 'http://163.172.46.122/files/master/art/anime/fanart.jpg'
    ...
    def cartoons(self, url):
        try:
            ...
            for i in self.list: i.update({'nextaction': 'toons.cartoons', 'nexticon': self.cartoons_image % (random.randint(1,10)), 'nextfanart': self.cartoons_fanart})

            for i in self.list: i.update({'action': 'toons.cartoonstreams'})
    ...
    def cartoongenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i.title(), 'url': self.cartoongenres_link % i, 'image': self.cartoons_image % (random.randint(1,10)), 'fanart': self.cartoons_fanart, 'action': 'toons.cartoons'})
    ...
    def cartoonstreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'toons.cartoonplay'})
            for i in self.list: i.update({'fanart': self.cartoons_fanart})
    ...
    def anime(self, url):
        try:
            ...
            for i in self.list: i.update({'action': 'toons.animestreams'})
    ...
    def animegenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i, 'url': self.animegenres_link % i.replace(' ','%20'), 'image': self.anime_image % (random.randint(1,10)), 'fanart': self.anime_fanart, 'action': 'toons.anime'})
    ...
    def animestreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'toons.animeplay'})
            for i in self.list: i.update({'fanart': self.anime_fanart})
