...
class sources:
    ...
    def playp(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select):
        try:
            url = None
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.master.container.items'

        self.metaProperty = 'plugin.video.master.container.meta'
