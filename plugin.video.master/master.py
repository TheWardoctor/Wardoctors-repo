...
if action == None:
    ...
    from resources.lib.indexers import streams
    streams.indexer().parental_controls()	
	
elif action == 'qdirectory':
    from resources.lib.indexers import streams
    streams.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import streams
    streams.indexer().getx(url)
    ...
    from resources.lib.indexers import streams
    streams.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import streams
    streams.indexer().youtube(url, action)
	
elif action == 'play':
    from resources.lib.indexers import streams
    streams.player().play(url, content)
    ...
    from resources.lib.indexers import streams
    streams.indexer().search(url=None)
    ...
    from resources.lib.indexers import radios
    radios.kickinradiocats(url)

elif action == 'toons.root' or action == 'cartoon':
    from resources.lib.indexers import toons
    toons.indexer().root()

elif action == 'toons.cartoons':
    from resources.lib.indexers import toons
    toons.indexer().cartoons(url)

elif action == 'toons.cartoongenres':
    from resources.lib.indexers import toons
    toons.indexer().cartoongenres()

elif action == 'toons.cartoonstreams':
    from resources.lib.indexers import toons
    toons.indexer().cartoonstreams(url, image, fanart)

elif action == 'toons.cartoonplay':
    from resources.lib.indexers import toons
    toons.indexer().cartoonplay(url)

elif action == 'toons.anime':
    from resources.lib.indexers import toons
    toons.indexer().anime(url)

elif action == 'toons.animegenres':
    from resources.lib.indexers import toons
    toons.indexer().animegenres()

elif action == 'toons.animestreams':
    from resources.lib.indexers import toons
    toons.indexer().animestreams(url, image, fanart)

elif action == 'toons.animeplay':
    from resources.lib.indexers import toons
    toons.indexer().animeplay(url)
    ...
    from resources.lib.modules import sources
    sources.sources().playp(title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select)
