...
ADDON = xbmcaddon.Addon(id='plugin.video.master.catchup')
...
def CATEGORIES():
    addDir('UKTV - Categories','drama',3,img+'/categories.png','')
    addDir('UKTV - A To Z','url',5,img+'/a-z.png','')
    addDir('UKTV - Search','url',11,img+'/search.png','')
    addDir('Dave','dave',1,img+'/dave.png','')
    addDir('Really','really',1,img+'/really.png','')
    addDir('Yesterday','yesterday',1,img+'/yesterday.png','')
    addDir('Drama','drama',1,img+'/drama.png','')
    addDir('Blaze','url',13,img+'/blaze.png','')
    addDir('Quest','url',14,img+'/quest.png','')
...
elif mode==13: vod_blaze()
elif mode==14: vod_quest()
elif mode==15: play(url)
elif mode==16: vod_play(url)    
#elif mode==17: getVOD()
