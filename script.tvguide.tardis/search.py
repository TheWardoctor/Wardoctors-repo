...
f = xbmcvfs.File('special://profile/addon_data/script.tvguide.tardis/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/script.tvguide.tardis/resources/favourites.xml')
    data = f.read()
    f.close()
