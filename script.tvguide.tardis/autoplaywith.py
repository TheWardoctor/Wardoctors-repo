...
class Autoplaywith(object):
    ...
    def _scheduleAutoplaywith(self, channelId, programTitle, startTime, endTime):
        ...
        xbmc.executebuiltin('AlarmClock(%s-start,RunScript(special://home/addons/script.tvguide.tardis/playwith.py,%s,%s),%d,True)' %
        ...
        if ADDON.getSetting('autoplaywiths.stop') == 'true':
            xbmc.executebuiltin('AlarmClock(%s-stop,RunScript(special://home/addons/script.tvguide.tardis/stopwith.py,%s,%s),%d,True)' %
