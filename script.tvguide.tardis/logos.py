...
for path in unique:
    ...
    for file in thumbnails:
        ...
        thumbs[file] = thumb
logo_folder = 'special://profile/addon_data/script.tvguide.tardis/addon_logos/'
for addonId in sorted(logos):
    folder = 'special://profile/addon_data/script.tvguide.tardis/addon_logos/%s' % addonId
...
dialog.notification("TV Guide - Tardis","Done: Download Logos")
