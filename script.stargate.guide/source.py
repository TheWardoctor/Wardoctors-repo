...
SETTINGS_TO_CHECK = ['source', 'xmltv.type', 'xmltv.file', 'xmltv.url', 'xmltv2.type', 'xmltv2.file', 'xmltv2.url', 'xmltv.logo.folder', 'logos.source', 'logos.folder', 'logos.url', 'source.source', 'yo.countries' , 'tvguide.co.uk.systemid']

if ADDON.getSetting('xmltv2.url') == 'Albanian': getXMLTV2 = 'http://163.172.46.122/files/guide/albania.xml'
if ADDON.getSetting('xmltv2.url') == 'Arabic': getXMLTV2 = 'http://163.172.46.122/files/guide/arabic.xml'
if ADDON.getSetting('xmltv2.url') == 'Balkans': getXMLTV2 = 'http://163.172.46.122/files/guide/balkans.xml'
if ADDON.getSetting('xmltv2.url') == 'Belgian': getXMLTV2 = 'http://163.172.46.122/files/guide/belgian.xml'
if ADDON.getSetting('xmltv2.url') == 'Brazilian': getXMLTV2 = 'http://163.172.46.122/files/guide/brazilian.xml'
if ADDON.getSetting('xmltv2.url') == 'Bulgarian': getXMLTV2 = 'http://163.172.46.122/files/guide/bulgarian.xml'
if ADDON.getSetting('xmltv2.url') == 'Czech': getXMLTV2 = 'http://163.172.46.122/files/guide/czech.xml'
if ADDON.getSetting('xmltv2.url') == 'French': getXMLTV2 = 'http://163.172.46.122/files/guide/french.xml'
if ADDON.getSetting('xmltv2.url') == 'German': getXMLTV2 = 'http://163.172.46.122/files/guide/german.xml'
if ADDON.getSetting('xmltv2.url') == 'Greek': getXMLTV2 = 'http://163.172.46.122/files/guide/greek.xml'
if ADDON.getSetting('xmltv2.url') == 'Indian': getXMLTV2 = 'http://163.172.46.122/files/guide/indian.xml'
if ADDON.getSetting('xmltv2.url') == 'Latino': getXMLTV2 = 'http://163.172.46.122/files/guide/latino.xml'
if ADDON.getSetting('xmltv2.url') == 'Netherlands': getXMLTV2 = 'http://163.172.46.122/files/guide/netherlands.xml'
if ADDON.getSetting('xmltv2.url') == 'Nordic': getXMLTV2 = 'http://163.172.46.122/files/guide/nordic.xml'
if ADDON.getSetting('xmltv2.url') == 'Polish': getXMLTV2 = 'http://163.172.46.122/files/guide/polish.xml'
if ADDON.getSetting('xmltv2.url') == 'Portugeuse': getXMLTV2 = 'http://163.172.46.122/files/guide/portugeuse.xml'
if ADDON.getSetting('xmltv2.url') == 'Romanian': getXMLTV2 = 'http://163.172.46.122/files/guide/romanian.xml'
if ADDON.getSetting('xmltv2.url') == 'Russian': getXMLTV2 = 'http://163.172.46.122/files/guide/russian.xml'
if ADDON.getSetting('xmltv2.url') == 'Slovenia': getXMLTV2 = 'http://163.172.46.122/files/guide/slovenia.xml'
if ADDON.getSetting('xmltv2.url') == 'Spanish': getXMLTV2 = 'http://163.172.46.122/files/guide/spanish.xml'
if ADDON.getSetting('xmltv2.url') == 'Swiss': getXMLTV2 = 'http://163.172.46.122/files/guide/swiss.xml'
if ADDON.getSetting('xmltv2.url') == 'Turkish': getXMLTV2 = 'http://163.172.46.122/files/guide/turkish.xml'
...
class Database(object):
    ...
    def loadOptional(self,force):
        ...
        if (ADDON.getSetting('addons.ini.subscriptions') == "true"):
            file_name = 'special://profile/addon_data/script.stargate.guide/subscriptions.ini'
            ...
            for (name,sub) in name_sub:
                ...
                f.close
                if not data:
                    d.notification("Stargate Guide","%s - %s" % (name,sub), xbmcgui.NOTIFICATION_ERROR)
        ...
        path = "special://profile/addon_data/script.stargate.guide/addons.ini"
        if not xbmcvfs.exists(path):
            f = xbmcvfs.File(path,"w")
            f.close()

        addons_ini = "special://profile/addon_data/script.stargate.guide/addons.ini"
        ...
        if ADDON.getSetting('addons.ini.enabled') == 'true':
            ...
            if data:
                ...
                if encode and enckey:
                    ...
                    f = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/addons.aes.ini','wb')
                    f.write(ddata)
                    f.close()
                elif enckey:
                    import pyaes,base64
                ...
                xbmcvfs.File('special://profile/addon_data/script.stargate.guide/addons.ini','wb').write(data)

        if (ADDON.getSetting('addons.ini.subscriptions') == "true") or (ADDON.getSetting('addons.ini.overwrite') == "1"):
            streams = {}
            streams["script.stargate.guide"] = {}
            ...
            if (ADDON.getSetting('addons.ini.subscriptions') == "true"):
                for name in subscription_streams:
                    if name:
                        streams["script.stargate.guide"][name] = subscription_streams[name]
        ...
        while True:
            ...
            try:
                ...
                if cancel_requested_callback is None:
                    xbmc.log('[script.stargate.guide] Database is locked, bailing out...', xbmc.LOGDEBUG)
                    break
                else:  # ignore 'database is locked'
                    xbmc.log('[script.stargate.guide] Database is locked, retrying...', xbmc.LOGDEBUG)

            except sqlite3.DatabaseError:
                self.conn = None
                if self.alreadyTriedUnlinking:
                    xbmc.log('[script.stargate.guide] Database is broken and unlink() failed', xbmc.LOGDEBUG)
                    break
                else:
                    try:
    ...
    def _updateChannelAndProgramListCaches(self, date, progress_callback, clearExistingProgramList):
        ...
        c = self.conn.cursor()
        try:
            xbmc.log('[script.stargate.guide] Updating caches...', xbmc.LOGDEBUG)
            ...
            if getData == True:
                xbmcvfs.delete('special://profile/addon_data/script.stargate.guide/category_count.ini')
    ...
    def exportChannelList(self):
        ...
        f = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/channels.ini','wb')
    ...
    def exportChannelIdList(self):
        ...
        f = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/channel_id_title.ini','wb')
    ...
    def _getChannelList(self, onlyVisible, all=False):
        ...
        if all == False and self.category and self.category != "Any":
            f = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/categories.ini','rb')
    ...
    def _setCustomStreamUrl(self, channel, stream_url):
        if stream_url is not None:
            ...
            if ADDON.getSetting("addon.logos") == "true":
                file_name = 'special://profile/addon_data/script.stargate.guide/icons.ini'
    ...
    def _createTables(self):
        ...
        #except sqlite3.OperationalError, ex:
            ...
            xbmc.log("(script.stargate.guide) %s" % detail, xbmc.LOGERROR)
            dialog = xbmcgui.Dialog()
            dialog.notification('script.stargate.guide', 'database exception %s' % detail, xbmcgui.NOTIFICATION_ERROR , 5000)
...
class XMLTVSource(Source):
    PLUGIN_DATA = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.stargate.guide'))
    KEY = 'xmltv'
    INI_TYPE_FILE = 0
    INI_TYPE_URL = 1
    INI_FILE = 'addons.ini'
    ...
    def __init__(self, addon, force):
        ...
        if self.xmltvType == XMLTVSource.XMLTV_SOURCE_FILE:
            ...
            if os.path.exists(customFile):
                ...
                xbmc.log('[script.stargate.guide] Use local file: %s' % customFile, xbmc.LOGDEBUG)
                self.xmltvFile = customFile
            else:
                # Probably a remote file
                xbmc.log('[script.stargate.guide] Use remote file: %s' % customFile, xbmc.LOGDEBUG)
        ...
        if ADDON.getSetting('xmltv2.enabled') == 'true':
            if self.xmltv2Type == XMLTVSource.XMLTV_SOURCE_FILE:
                ...
                self.xmltv2File = self.updateLocalFile(addon.getSetting('xmltv2.url'), getXMLTV2, addon, force=force)
    ...
    def parseXMLTVDate(self, origDateString):
        ...
        try:
            ...
            xbmc.log('[script.stargate.guide] strptime error with this date: %s' % dateString, xbmc.LOGDEBUG)
    ...
    def parseXMLTV(self, context, f, size, logoFolder, progress_callback):
        ...
        data = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/channel_id_shortcut.ini','rb').read()
        id_shortcuts = {}
        if data:
            lines = data.splitlines()
            for line in lines:
        ...
        if ADDON.getSetting('update.progress') == 'true':
            ...
            d.create('Stargate Guide', "parsing xmltv")
        category_count = {}
        ...
        if ADDON.getSetting('update.progress') == 'true':
            ...
            d.close()
        f = xbmcvfs.File('special://profile/addon_data/script.stargate.guide/category_count.ini',"wb")
...
class TVGUKNow2Source(Source):
    ...
    def getDataFromExternal2(self, date, ch_list, progress_callback=None):
        ...
        if ADDON.getSetting('update.progress') == 'true':
            d = xbmcgui.DialogProgressBG()
            d.create('Stargate Guide', "grabbing tvguide.co.uk listings")
        systemid = {
            "Popular":"7",
            "Sky":"5",
            "Virgin M+":"2",
