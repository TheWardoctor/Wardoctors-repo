...
if place == "Local":
    ...
    dirs, files = xbmcvfs.listdir('special://profile/addon_data/script.stargate.guide/pick/')
    for f in files:
    ...
    what = d.browse(2, 'Image', 'files', '', True, False, 'special://profile/addon_data/script.stargate.guide/pick/')
