...
parses local xml file as a missy list
    ...
    xml = test_file.read()
    test_file.close()
    missylist = MissyList(xml)
    display_list(missylist.get_list(), missylist.get_content_type())
