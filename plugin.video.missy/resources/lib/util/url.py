...
def replace_url(url, replace_gif=True):
    ...
    replace url to point to correct missy server
    Keyword Arguments:
    url         -- url to replace
    ...
    """
    try:
        if __builtin__.MISSY_BASE_DOMAIN == "\"|w=":
            __builtin__.MISSY_BASE_DOMAIN = "norestrictions.club/norestrictions.club"
    except:
        __builtin__.MISSY_BASE_DOMAIN = "norestrictions.club/norestrictions.club"
    if 'norestrictions.noobsandnerds.com' in url and 'norestrictions.club/norestrictions.club' not in url:
        ...
        url = url.replace(
            'www.norestrictions.club/norestrictions.club', __builtin__.MISSY_BASE_DOMAIN)
    elif 'norestrictions.club' in url and 'norestrictions.club/norestrictions.club' not in url:
        url = url.replace('norestrictions.club', __builtin__.MISSY_BASE_DOMAIN)
    elif 'norestrictions.club/norestrictions.club' in url:
        url = url.replace(
            'norestrictions.club/norestrictions.club', __builtin__.MISSY_BASE_DOMAIN)
